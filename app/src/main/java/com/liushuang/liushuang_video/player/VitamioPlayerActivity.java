...
public class VitamioPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private Handler mHandler = new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case SPEED:
                    String netSpeed = mUtils.getNetSpeed(VitamioPlayerActivity.this);
...
//                Toast.makeText(VitamioPlayerActivity.this, "播放出错了哦", Toast.LENGTH_SHORT).show();
                showErrorDialog();
                return true;
...
//                Toast.makeText(SystemPlayerActivity.this, "播放结束了", Toast.LENGTH_SHORT).show();
    ...
    private void startSystemPlayer() {
        ...
        Intent intent = new Intent(VitamioPlayerActivity.this, SystemPlayerActivity.class);
        if (mMediaItems != null && mMediaItems.size() > 0){
